...
var file_j5_builds_github_v1_checks_proto_rawDesc = []byte{
	...
	0x6d, 0x69, 0x74, 0x22, 0x44, 0x0a, 0x06, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x14, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x68, 0x61, 0x42, 0x40, 0x5a, 0x3e, 0x67, 0x69, 0x74,
...
var file_j5_builds_github_v1_checks_proto_goTypes = []interface{}{
...
func file_j5_builds_github_v1_checks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_j5_builds_github_v1_checks_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_j5_builds_github_v1_checks_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_j5_builds_github_v1_checks_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Commit); i {
			case 0:
				return &v.state
			case 1:
