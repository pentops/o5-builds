...
type RepoPSM = psm.StateMachine[
	...
	*RepoData,    // implements psm.IStateData
...
func (msg *RepoState) PSMData() *RepoData {
	if msg.Data == nil {
		msg.Data = &RepoData{}
	}
	return msg.Data
...
// EXTEND RepoData with the psm.IStateData interface

// PSMIsSet is a helper for != nil, which does not work with generic parameters
func (msg *RepoData) PSMIsSet() bool {
	return msg != nil
}
...
func RepoPSMMutation[SE RepoPSMEvent](cb func(*RepoData, SE) error) psm.TransitionMutation[
	*RepoKeys,    // implements psm.IKeyset
	*RepoState,   // implements psm.IState
	RepoStatus,   // implements psm.IStatusEnum
	*RepoData,    // implements psm.IStateData
