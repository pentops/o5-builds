...
func (msg *RepoData) Clone() any {
	return proto.Clone(msg).(*RepoData)
}
func (msg *RepoData) J5Reflect() j5reflect.Root {
	return j5reflect.MustReflect(msg.ProtoReflect())
}

func (msg *RepoData) J5Object() j5reflect.Object {
	return j5reflect.MustReflect(msg.ProtoReflect()).(j5reflect.Object)
}
...
const (
	DeployTarget_Type_J_5Build DeployTargetTypeKey = "j5Build"
	DeployTarget_Type_O_5Build DeployTargetTypeKey = "o5Build"
)

func (x *DeployTargetType) TypeKey() (DeployTargetTypeKey, bool) {
	switch x.Type.(type) {
	case *DeployTargetType_J_5Build:
		return DeployTarget_Type_J_5Build, true
	case *DeployTargetType_O_5Build:
		return DeployTarget_Type_O_5Build, true
	default:
		return "", false
	}
}
...
func (x *DeployTargetType) Set(val IsDeployTargetTypeWrappedType) {
	...
	case *DeployTargetType_J5Build:
		x.Type = &DeployTargetType_J_5Build{J_5Build: v}
	case *DeployTargetType_O5Build:
		x.Type = &DeployTargetType_O_5Build{O_5Build: v}
	}
}
