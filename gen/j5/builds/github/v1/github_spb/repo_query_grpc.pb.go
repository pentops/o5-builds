...
const (
	RepoQueryService_GetRepo_FullMethodName        = "/j5.builds.github.v1.service.RepoQueryService/GetRepo"
	RepoQueryService_ListRepos_FullMethodName      = "/j5.builds.github.v1.service.RepoQueryService/ListRepos"
	RepoQueryService_ListRepoEvents_FullMethodName = "/j5.builds.github.v1.service.RepoQueryService/ListRepoEvents"
)
...
func (c *repoQueryServiceClient) GetRepo(ctx context.Context, in *GetRepoRequest, opts ...grpc.CallOption) (*GetRepoResponse, error) {
	...
	err := c.cc.Invoke(ctx, RepoQueryService_GetRepo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *repoQueryServiceClient) ListRepos(ctx context.Context, in *ListReposRequest, opts ...grpc.CallOption) (*ListReposResponse, error) {
	...
	err := c.cc.Invoke(ctx, RepoQueryService_ListRepos_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *repoQueryServiceClient) ListRepoEvents(ctx context.Context, in *ListRepoEventsRequest, opts ...grpc.CallOption) (*ListRepoEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, RepoQueryService_ListRepoEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var RepoQueryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "j5/builds/github/v1/service/repo_query.proto",
}
